...
/*
NombreCadena.concat() -> este metodo lo que hace es juntar una o mas
cadenas devolviendo una cadena nueva combinada con las demas.

NombreCadena.startsWith() -> este metodo lo que hace es verificar si el comienzo
...
NombreCadena.endsWith() -> este metodo hace lo mismo que startWith la diferencia
...
NombreCadena.includes() -> Este metodo no verfica si al comienzo a el final dos cadenas
...
NombreCadena.indexOf() -> este metodo lo unico que hace es indicar en que numero de letra se encuentra la palabra
...
NombreCadena.lastIndexOf() -> Este metodo en vez de mostrar la posicion de la primera palabra que se este buscando lo que 
...
NombreCadena.padStart() -> El método padStart() rellena la cadena actual con una cadena dada (repetida eventualmente) de modo
...
NombreCadena.padEnd() -> El padEnd() método rellena la cadena actual con una cadena determinada (repetida, si es necesario) para que la cadena
...
NombreCadena.repeat() -> Este metodo tiene la funcionalidad de repetir cadenas las veces que nosotros le indiquemos. EJEMPLO
...
NombreCadena.split() -> Es un metodo que tiene como funcionalidad convertir una cadena en un array que esta separado de acuerdo a un indicador
...
NombreCadena.substring() -> Este metodo es como el metodo assoc() en php la funcionalidad que tiene es devolver una posicion inicial y otra final de una
...
NombreCadena.toLowerCase() -> Este metodo lo que hace es convertir una cadena a letra minuscula EJEMPLO

cadena1 = "Buenas tardes";
resultado = cadena1.toLowerCase(); -> buenas tardes

NombreCadena.toUpperCase() -> Este metodo lo que hace es convertir una cadena a letra mayuscula EJEMPLO

cadena1 = "Buenas tardes";
resultado = cadena1.toUpperCase(); -> BUENAS TARDES

NombreCadena.toString() -> Este metodo lo que permite hacer es convertir cualquier variable en un string. EJEMPLO

variable = 12550;
resultado = variable.toString(); -> "12550";  

NombreCadena.trim() -> Este metodo lo que hace es eliminar los espacios tanto de la derecha como de la izquierda sobrantes
en una cadena de texto -> string. EJEMPLO

cadena1  = "           Hola         ";
resultado = cadena1.trim(); -> "Hola"; 

NombreCadena.trimStart() -> Este metodo lo que hace es eliminar los espacios de una cadena de texto pero al principio 
EJEMPLO
...
NombreCadena.trimEnd() -> Este metodo lo que hace es eliminar los espacios de una cadena de texto pero al final 
EJEMPLO
...
NombreCadena.length -> Esta es una propiedad de las cadenas de texto tiene como funcionalidad devolver el tamaño de una cadena 
